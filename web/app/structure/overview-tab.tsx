...
export function OverviewTab({
  ...
  return (
    <>
      ...
      <section className="section section-lg">
        <div className="card-header"><div><h2 className="card-title">Underlying assets</h2><p className="card-description">Linked assets open a vault comparison. Unlinked assets have no valid multi-vault comparison.</p></div></div>
