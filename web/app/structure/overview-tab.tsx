  ...
  return (
    <>
      <section className="section section-lg">
        <div className="card-header"><div><h2 className="card-title">Selected vault set</h2><p className="card-description">Selected vaults only.</p></div></div>
      ...
      <section className="section section-lg">
        <div className="card-header"><div><h2 className="card-title">Underlying assets</h2></div></div>
